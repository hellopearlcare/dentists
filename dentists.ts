		...
		"practices": [
			{
				...
				"insurances": [
					"Advantica Preferred",
					"Aetna Umbrella Premier",
					"Ameri Plan",
					"Ameritas Umbrella Geha",
					"Anthem Blue Cross Blue Shield / Unicare/ Wellpoint",
					"Anthem/Unicare",
					"Aon",
					"Assurant",
					...
					"Careington Platinum",
					"Cigna",
					"Cosemetic Dental Discount",
					"Delta",
					"Delta Premier",
					"Dentegra",
					"Florida Combined Life - Blue Cross Blue Shield",
					"GEHA / Connection Dental",
					"Guardian - Umbrella Premier",
					"Humana",
					"Metlife",
					"Premier",
					"Principle",
					...
					"Solstice",
					"Uni-Care 100",
					"United Concordia - NAT ADV - UMBRELLA DHA",
					"United Healthcare"
				],
				"schedule": {
					"Monday": "8AM-5PM",
